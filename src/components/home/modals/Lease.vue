...
export default {
    ...
    methods: {
        ...
        coldApi: function() {
            if (this.coldAddresses[this.coldAddress].api === 1 && (BigNumber(this.coldAmount).isLessThan(BigNumber(Number.MAX_SAFE_INTEGER).dividedBy(1e8)) || BigNumber(this.coldAmount).mod(100).isEqualTo(0))) {
                return 1
            } else {
                return API_VERSION
            }
