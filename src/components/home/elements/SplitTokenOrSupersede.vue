...
export default {
    ...
    computed: {
        ...
        dataObject() {
            ...
            tra['stored_tx']['functionExplain'] = this.functionName === 'Split Token' ? 'Set token unity to ' + tra['stored_tx']['functionData'][0]['value'] : 'Set issuer to ' + tra['stored_tx']['functionData'][0]['value']
            return tra
        }
    },
    methods: {
